...
function find_parameters(x::AbstractArray, n::Int; threshold_min::Float64 = 0.0, threshold_max::Float64 = maximum(pairwise(Euclidean(), x, x)), large_prec = 20, small_prec = 50, num_samples = 0.05)
    ##
