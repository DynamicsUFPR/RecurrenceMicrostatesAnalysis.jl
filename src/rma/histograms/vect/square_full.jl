...
function square_full(data_x::AbstractArray, data_y::AbstractArray, parameters, structure::AbstractVector{Int}, space_size::AbstractVector{Int}, func::F, dim::AbstractVector{Int}, hypervolume::Int, total_microstates::Int, metric::Metric) where {F}
    #
