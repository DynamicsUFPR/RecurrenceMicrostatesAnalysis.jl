...
function triangle_random_async(data_x::AbstractArray, data_y::AbstractArray, parameters, structure::AbstractVector{Int}, space_size::AbstractVector{Int}, num_samples::Int, func::F, dim::AbstractVector{Int}, metric::Metric) where {F}
    #
    ...
    function triangle_random_task(segment::UnitRange{Int})
        ...
        @inbounds for _ in segment
            ...
            @fastmath hg[compute_triangle_index(data_x, data_y, parameters, structure, func, dim, idx, recursive_index, p_vect, metric)] += 1
        end
